...
export const thought: Thought = {
  slug: "cookies-simplified-who-and-how",
  title: 'Cookies Simplified – "Who" and "How"',
  date: "2022-04-15",
  excerpt:
...
One is the activation pipes that FullThrottle is transforming with specific unique outlets, like Amazon Advertising, Comcast/Effectv, Charter/Spectrum Reach, and iHeartMedia. This is to better deliver the "Immersive Household" with total audio, display, and video media solutions, specifically using the "who" that we are identifying on behalf of brands.
