...
export const thought: Thought = {
  ...
  answer:
    "No. Google never dropped third-party cookies, and it does not matter. As of mid-2024, roughly 70% of US internet traffic was already cookieless: about 49% sits outside Chrome, and around 40% of Chrome users disable third-party cookies by choice. Owning first-party audience data is the durable strategy regardless.",
